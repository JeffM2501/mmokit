...
namespace Axiom.RenderSystems.DirectX9
{
    ...
    public class D3DWindow : RenderWindow
    {
        ...
        public override void Create( string name, int width, int height, int colorDepth, bool isFullScreen, int left, int top, bool depthBuffer, params object[] miscParams )
        {
            ...
            {
                D3D.PresentParameters presentParams = new D3D.PresentParameters( device.PresentationParameters );
                ...
                swapChain = new D3D.SwapChain( device, presentParams );
        ...
        public override object GetCustomAttribute( string attribute )
        {
            switch ( attribute )
            {
                ...
                case "D3DBACKBUFFER":
                    ...
                    {
                        return swapChain.GetBackBuffer( 0, D3D.BackBufferType.Mono );
                    }
                // CMH - End
            }
        ...
        public override void Resize( int width, int height )
        {
            ...
            if ( !isFullScreen )
            {
                D3D.PresentParameters p = new D3D.PresentParameters( swapChain.PresentParameters );
