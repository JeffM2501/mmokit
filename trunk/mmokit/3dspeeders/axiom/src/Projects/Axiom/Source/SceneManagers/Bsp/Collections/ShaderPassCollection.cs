...
//     <id value="$Id: ShaderPassCollection.cs 1004 2007-01-02 18:57:49Z borrillis $"/>
// </file>
...
using T = Axiom.SceneManagers.Bsp.ShaderPass;
...
namespace Axiom.SceneManagers.Bsp.Collections
{
    ...
    /// </summary>
    public class ShaderPassCollection : Axiom.Collections.AxiomCollection
    {
        #region Constructors
